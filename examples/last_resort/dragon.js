...
var toldBy = "the dragon";

// spin.order = "retrograde";
spin.timePhrases = true;
spin.main = "0;2;5-6;8-10";
spin.i = "dragon";
...
names.dragon = new Names("the dragon", "the dragon");
names.bartender = new Names("the bartender");

names.things = new Names("her things");
names.hope = new Names("the hope");
names.pina_colada = new Names("the pina colada");
